...
- **6.1 Escalabilidade**: A aplicação foi projetada para ser escalável por meio do desenvolvimento de microsserviços, que permite aumentar ou reduzir a capacidade conforme a demanda. 

- **6.2 Disponibilidade**: O uso de um serviço com banco de dados em nuvem garante alta disponibilidade, reduzindo o risco de downtime. 

- **6.3 Desempenho**: A aplicação utiliza uma estrutura leve (Flask) para garantir tempos de resposta rápidos. O uso de um banco de dados relacional permite consultas eficientes. 
